...
[![Join the chat at https://gitter.im/thmspl/hackmd][gitter-image]][gitter-url]
...
[![Try in PWD](https://cdn.rawgit.com/play-with-docker/stacks/cff22438/assets/images/button.png)](http://play-with-docker.com?stack=https://github.com/thmspl/docker-hackmd/raw/master/docker-compose.yml&stack_name=hackmd)


**Debian-based version:**

[![latest](https://images.microbadger.com/badges/version/thmspl/hackmd.svg)](https://microbadger.com/images/thmspl/hackmd "Get your own version badge on microbadger.com") [![](https://images.microbadger.com/badges/image/thmspl/hackmd.svg)](https://microbadger.com/images/thmspl/hackmd "Get your own image badge on microbadger.com")


**Alpine-based version:**

[![latest-alpine](https://images.microbadger.com/badges/version/thmspl/hackmd:latest-alpine.svg)](https://microbadger.com/images/thmspl/hackmd:latest-alpine "Get your own version badge on microbadger.com") [![](https://images.microbadger.com/badges/image/thmspl/hackmd:latest-alpine.svg)](https://microbadger.com/images/thmspl/hackmd:latest-alpine "Get your own image badge on microbadger.com")

The easiest way to setup HackMD using docker are using the following three commands:

```console
git clone https://github.com/thmspl/docker-hackmd.git
cd docker-hackmd
docker-compose up
```
Read more about it in the [docker repository…](https://github.com/thmspl/docker-hackmd)
...
* [migration-to-0.5.0](https://github.com/thmspl/migration-to-0.5.0)

We don't use LZString to compress socket.io data and DB data after version 0.5.0.
Please run the migration tool if you're upgrading from the old version.

* [migration-to-0.4.0](https://github.com/thmspl/migration-to-0.4.0)
...
[gitter-url]: https://gitter.im/thmspl/hackmd?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge
[travis-image]: https://travis-ci.org/thmspl/hackmd.svg?branch=master
[travis-url]: https://travis-ci.org/thmspl/hackmd
[github-version-badge]: https://img.shields.io/github/release/thmspl/hackmd.svg
[github-release-page]: https://github.com/thmspl/hackmd/releases
