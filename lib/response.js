  ...
  // Check if you got the new one
    ...
    function actionPDF(req, res, note) {
      ...
      if (action === 'pdf-NextEvent') {
        ...
        var headerImg = '<img src="' + base + '/nextevent_logo_quer.png' + '" alt="Logo" class="header-NextEvent"/>'
        var headerAddress = `
        ...
        var headerImg = '<img src="' + base + '/nexbyte_wordhead.jpg' + '" alt="Logo" class="header-nexbyte"/>'
        /*var headerAddress = `
          <table class="firstpage header">
            <tbody>
              <tr>
