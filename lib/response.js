  ...
  // Check if you got the new one
    ...
    function actionPDF(req, res, note) {
      ...
      if (action === 'pdf-NextEvent') {
        ...
        var headerImgPath = base + '/nextevent_logo_quer.png'
        var headerAddress = `
          <table class="firstpage header">
            <tbody>
              <tr>
                <td>NextEvent AG</td><td>mail@nextevent.com</td>
              </tr>
              <tr>
                <td>Bälliz 24</td><td>www.nextevent.com</td>
              </tr>
              <tr>
                <td>CH-3600 Thun</td><td>+41 33 511 22 55</td>
              </tr>
            </tbody>
          </table>
        `
        ...
        var headerImgPath = base + '/nexbyte_wordhead.jpg'
        /*var headerAddress = `
          <table class="firstpage header">
            <tbody>
              <tr>
                <td>nexbyte AG</td><td>mail@nexbyte.com</td>
              </tr>
              <tr>
                <td>Bälliz 24</td><td>www.nexbyte.com</td>
              </tr>
              <tr>
                <td>CH-3600 Thun</td><td>+41 33 511 22 55</td>
              </tr>
      ...
      var html = `
        <link rel="stylesheet" href="` + base + `/css/pdf.css" type="text/css"/>
        <link rel="stylesheet" href="` + base + `/css/` + action + `.css" type="text/css"/>
        <body>
          <div id="pageHeader">
            <img src="` + headerImgPath + `" alt="Logo" class="header"/>
          </div>
          <div id="pageHeader-first">
            <img src="` + headerImgPath + `" alt="Logo" class="header"/>`
            + (typeof headerAddress !== 'undefined' && headerAddress ? headerAddress : '') +
          `</div>
          <div id="pageContent">` + extracted.html + `</div>
